    ...
    <section className="min-h-screen flex flex-col ">
      <header className="flex justify-between  items-center border border-t-0 border-x-0 border-b-gray-200 py-2 px-20">
        ...
        <div className="box_login flex justify-between items-center gap-3">
          ...
          <Link to="/login">
            <button className="hover:cursor-pointer px-7 py-2 bg-purple-200 text-purple-700 rounded-3xl text-sm font-bold hover:bg-purple-400 hover:text-white transition">
              Login
            </button>
          </Link>
        </div>
          ...
          <div className="box_group w-lg mx-auto">
            <div className="box_title mb-3">
              ...
              <p className="text-sm text-gray-500 ">
                Create your free account to unlock unlimited canvas space and
